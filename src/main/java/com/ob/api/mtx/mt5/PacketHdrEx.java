...
public class PacketHdrEx implements FromBufReader { //sizeof 0x11 c
    /*[FieldOffset(0)]*/
...
//ORIGINAL LINE: public ushort Flags;
    ...
    /*[FieldOffset(9)]*///C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public uint m_nOriginalSize;
    public int m_nOriginalSize; //9
    /*[FieldOffset(13)]*///C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
