...
public class AccountRec implements FromBufReader {
...
//ORIGINAL LINE: public ulong Login;
    public long Login;
    /*[FieldOffset(8)]*/ /*[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 8)]*///C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public byte[] s8;
    public byte[] s8;
    /*[FieldOffset(16)]*/ /*[MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 16)]*/ public String Type;
    /*[FieldOffset(48)]*/ /*[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 152)]*///C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public byte[] s30;
    ...
    /*[FieldOffset(472)]*/ /*[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 56)]*///C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public byte[] s1D8;
    public byte[] s1D8;
    /*[FieldOffset(528)]*/ public int s210;
    /*[FieldOffset(532)]*/ public int s214;
    /*[FieldOffset(536)]*/ /*[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 8)]*///C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public byte[] s218;
    public byte[] s218;
    /*[FieldOffset(544)]*/ /*[MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 32)]*/ public String s220;
    /*[FieldOffset(608)]*/ /*[MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 32)]*/ public String s260;
    ...
    /*[FieldOffset(1344)]*/ /*[MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 64)]*/ public String s540;
    /*[FieldOffset(1472)]*/ /*[MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 32)]*/ public String s5C0;
    /*[FieldOffset(1536)]*/ /*[MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 16)]*/ public String s600;
    /*[FieldOffset(1568)]*/ /*[MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 64)]*/ public String s620;
    /*[FieldOffset(1696)]*/ public int s6A0;
    /*[FieldOffset(1700)]*/ /*[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 136)]*///C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public byte[] s6A4;
    ...
    /*[FieldOffset(1876)]*/ /*[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 52)]*///C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public byte[] s754;
    public byte[] s754;
    /*[FieldOffset(1928)]*/ public double Blocked;
    /*[FieldOffset(1936)]*/ /*[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 84)]*///C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public byte[] s790;
    ...
    /*[FieldOffset(2044)]*/ /*[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 312)]*///C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public byte[] s7FC;
    public byte[] s7FC;
    /*[FieldOffset(2356)]*/ /*[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 128)]*///C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public byte[] s934;
    public byte[] s934;
    /*[FieldOffset(2484)]*/ /*[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 256)]*///C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
