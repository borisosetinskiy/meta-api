...
public class TradeRequest implements FromBufReader {
    // <summary>
    /**
     * Request id
     */
...
//ORIGINAL LINE: public byte[] s198;
     ...
     * Expiration type
     */
    /*[FieldOffset(496)]*/    public ExpirationType expirationType = ExpirationType.values()[0];
    /**
     * Request flags
     */
...
//ORIGINAL LINE: st.s2B0 = new byte[112];
    ...
    public String toString() {
        return "TradeRequest{" +
               "RequestId=" + RequestId +
//				", s4=" + Arrays.toString(s4) +
               ", TradeType=" + TradeType +
               ", Login=" + Login +
//				", s50=" + Arrays.toString(s50) +
               ...
               ", Digits=" + Digits +
               ", s174=" + s174 +
//				", s17C=" + Arrays.toString(s17C) +
               ", OrderTicket=" + OrderTicket +
//				", s198=" + Arrays.toString(s198) +
               ", s1D8=" + s1D8 +
...
//				", s200=" + Arrays.toString(s200) +
               ", Price=" + Price +
               ", OrderPrice=" + OrderPrice +
               ", StopLoss=" + StopLoss +
               ", TakeProfit=" + TakeProfit +
               ", Deviation=" + Deviation +
//				", s238=" + Arrays.toString(s238) +
               ", ExpertId=" + ExpertId +
               ", Comment='" + Comment + '\'' +
               ", DealTicket=" + DealTicket +
               ", ByCloseTicket=" + ByCloseTicket +
//				", s2B0=" + Arrays.toString(s2B0) +
               '}';
    }
}