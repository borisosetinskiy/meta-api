...
public class AddressRecEx implements FromBufReader {
    public static final int Size = 1284;
    /*[FieldOffset(0)]*/
    public int s0;
    /*[FieldOffset(4)]*/ /*[MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 256)]*/ public String s4;
    /*[FieldOffset(516)]*/ /*[MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 256)]*/ public String s204;
    /*[FieldOffset(1028)]*/ /*[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 256)]*///C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
