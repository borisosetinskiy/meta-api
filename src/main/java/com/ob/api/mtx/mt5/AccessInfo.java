...
@Data
public class AccessInfo implements FromBufReader {
    /*[FieldOffset(0)]*/ /*[MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 32)]*/ public String ServerName;
    /*[FieldOffset(64)]*/ /*[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 36)]*///C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public byte[] s40;
    public byte[] s40;
    /*[FieldOffset(100)]*/ public int s64;
    /*[FieldOffset(104)]*/ public int s68;
    /*[FieldOffset(108)]*/ /*[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 160)]*///C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
