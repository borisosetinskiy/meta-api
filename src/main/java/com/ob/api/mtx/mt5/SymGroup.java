...
public class SymGroup implements FromBufReader {
    /*[FieldOffset(0)]*/ /*[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 8)]*///C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public byte[] s0;
    ...
    /*[FieldOffset(272)]*/ /*[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 32)]*///C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public byte[] s110;
    ...
    /*[FieldOffset(332)]*/ /*[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 52)]*///C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public byte[] s14C;
    public byte[] s14C;
    /*[FieldOffset(384)]*/ public int s180;
    /*[FieldOffset(388)]*/ public int PriceTimeout;
    /*[FieldOffset(392)]*/ /*[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 32)]*///C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public byte[] s188;
    ...
    /*[FieldOffset(444)]*///C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public uint RequestLots;
    public int RequestLots;
    /*[FieldOffset(448)]*/ public int s1C4;
    /*[FieldOffset(452)]*/ /*[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 24)]*///C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public byte[] s1C8;
    public byte[] s1C8;
    /*[FieldOffset(476)]*/ public int s1E0;
    /*[FieldOffset(480)]*/ /*[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 128)]*///C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public byte[] s1E4;
    public byte[] s1E4;
    /*[FieldOffset(608)]*/ public int s264;
    /*[FieldOffset(612)]*/ /*[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 128)]*///C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public byte[] s268;
    public byte[] s268;
    /*[FieldOffset(740)]*/ public int tmp1;
    /*[FieldOffset(744)]*///C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public uint MinVolume;
    public long MinVolume;
    /*[FieldOffset(748)]*/ //public int tmp2;
    /*[FieldOffset(752)]*///C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public uint MaxVolume;
    public long MaxVolume;
    /*[FieldOffset(756)]*/ //public int tmp3;
    /*[FieldOffset(760)]*/ public long VolumeStep;
    /*[FieldOffset(768)]*/ public long s300;
    /*[FieldOffset(776)]*/ /*[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 56)]*///C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public byte[] s308;
    ...
    /*[FieldOffset(1004)]*/ /*[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 40)]*///C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public byte[] s3EC;
    ...
    /*[FieldOffset(1068)]*/ /*[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 32)]*///C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: public byte[] s42C;
    public byte[] s42C;
    /*[FieldOffset(1100)]*/ public int s44C;
    /*[FieldOffset(1104)]*/ public int s450;
    /*[FieldOffset(1108)]*/ /*[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 120)]*///C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
...
//ORIGINAL LINE: st.s454 = new byte[120];
    ...
    public void CopyValues(SymGroup grp) {
        if (grp.DeviationRate != Integer.MAX_VALUE)
            DeviationRate = grp.DeviationRate;
        if (grp.RoundRate != Integer.MAX_VALUE)
            RoundRate = grp.RoundRate;
        if (grp.TradeMode != null)
            TradeMode = grp.TradeMode;
        if (grp.SL != Integer.MAX_VALUE)
            SL = grp.SL;
        if (grp.TP != Integer.MAX_VALUE)
            TP = grp.TP;
        if (grp.TradeType != null)
        ...
        if (grp.s340 != -1)
            s340 = grp.s340;
        if (grp.InitialMargin != Double.MAX_VALUE)
            InitialMargin = grp.InitialMargin;
        if (grp.MaintenanceMargin != Double.MAX_VALUE)
            MaintenanceMargin = grp.MaintenanceMargin;
        if (grp.InitMarginRate[0] != Double.MAX_VALUE)
            InitMarginRate[0] = grp.InitMarginRate[0];
        if (grp.InitMarginRate[1] != Double.MAX_VALUE)
            InitMarginRate[1] = grp.InitMarginRate[1];
        if (grp.InitMarginRate[2] != Double.MAX_VALUE)
            InitMarginRate[2] = grp.InitMarginRate[2];
        if (grp.InitMarginRate[3] != Double.MAX_VALUE)
            InitMarginRate[3] = grp.InitMarginRate[3];
        if (grp.InitMarginRate[4] != Double.MAX_VALUE)
            InitMarginRate[4] = grp.InitMarginRate[4];
        if (grp.InitMarginRate[5] != Double.MAX_VALUE)
            InitMarginRate[5] = grp.InitMarginRate[5];
        if (grp.InitMarginRate[6] != Double.MAX_VALUE)
            InitMarginRate[6] = grp.InitMarginRate[6];
        if (grp.InitMarginRate[7] != Double.MAX_VALUE)
            InitMarginRate[7] = grp.InitMarginRate[7];
        if (grp.MntnMarginRate[0] != Double.MAX_VALUE)
            MntnMarginRate[0] = grp.MntnMarginRate[0];
        if (grp.MntnMarginRate[1] != Double.MAX_VALUE)
            MntnMarginRate[1] = grp.MntnMarginRate[1];
        if (grp.MntnMarginRate[2] != Double.MAX_VALUE)
            MntnMarginRate[2] = grp.MntnMarginRate[2];
        if (grp.MntnMarginRate[3] != Double.MAX_VALUE)
            MntnMarginRate[3] = grp.MntnMarginRate[3];
        if (grp.MntnMarginRate[4] != Double.MAX_VALUE)
            MntnMarginRate[4] = grp.MntnMarginRate[4];
        if (grp.MntnMarginRate[5] != Double.MAX_VALUE)
            MntnMarginRate[5] = grp.MntnMarginRate[5];
        if (grp.MntnMarginRate[6] != Double.MAX_VALUE)
            MntnMarginRate[6] = grp.MntnMarginRate[6];
        if (grp.MntnMarginRate[7] != Double.MAX_VALUE)
            MntnMarginRate[7] = grp.MntnMarginRate[7];
        if (grp.HedgedMargin != Double.MAX_VALUE)
            HedgedMargin = grp.HedgedMargin;
        if (grp.s3DC != Double.MAX_VALUE)
            s3DC = grp.s3DC;
        if (grp.s3E4 != Double.MAX_VALUE)
            s3E4 = grp.s3E4;
        if (grp.SwapType != null)
            SwapType = grp.SwapType;
        if (grp.SwapLong != Double.MAX_VALUE)
            SwapLong = grp.SwapLong;
        if (grp.SwapShort != Double.MAX_VALUE)
            SwapShort = grp.SwapShort;
        if ((int) grp.ThreeDaysSwap.getValue() != Integer.MAX_VALUE)
