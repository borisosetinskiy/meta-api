...
public class DealInternal implements FromBufReader {
    /**
     * Deal ticket
     */
...
//ORIGINAL LINE: st.s70 = new byte[8];
        ...
        st.Lots = (double) st.Volume / 100000000;
...
//				", s178=" + Arrays.toString(s178) +
               ", FreeProfit=" + FreeProfit +
               ", s204=" + s204 +
//				", s20C=" + Arrays.toString(s20C) +
               ", TrailRounder=" + TrailRounder +
//				", s21C=" + Arrays.toString(s21C) +
               ", OpenTimeMs=" + OpenTimeMs +
//				", s22C=" + Arrays.toString(s22C) +
               ", s234=" + s234 +
               ", s23C=" + s23C +
               ", s244=" + s244 +
               ", s24C=" + s24C +
