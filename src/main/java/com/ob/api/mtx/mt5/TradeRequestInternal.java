...
//ORIGINAL LINE: [StructLayout(LayoutKind.Explicit, Size = 0x320, CharSet = CharSet.Unicode)] public class TradeRequestInternal
...
//ORIGINAL LINE: [FieldOffset(4)][MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 64)] public byte[] s4;
//C# TO JAVA CONVERTER TODO TASK: Java annotations will not correspond to .NET attributes:
    public byte[] s4;
    /**
     * Trade type
...
//C# TO JAVA CONVERTER TODO TASK: Java annotations will not correspond to .NET attributes:
    public long Login;
    //C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: [FieldOffset(80)][MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 72)] public byte[] s50;
//C# TO JAVA CONVERTER TODO TASK: Java annotations will not correspond to .NET attributes:
    public byte[] s50;
    /**
     * Transfer login
...
//C# TO JAVA CONVERTER TODO TASK: Java annotations will not correspond to .NET attributes:
    ...
    //C# TO JAVA CONVERTER TODO TASK: Java annotations will not correspond to .NET attributes:
//ORIGINAL LINE: [FieldOffset(160)][MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 32)] public string sA0;
    public String sA0;
    /**
     * Symbol currency
     */
//C# TO JAVA CONVERTER TODO TASK: Java annotations will not correspond to .NET attributes:
//ORIGINAL LINE: [FieldOffset(288)][MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 16)] public string Currency;
...
//ORIGINAL LINE: [FieldOffset(372)] public long s174;
    public long s174;
    //C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: [FieldOffset(380)][MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 20)] public byte[] s17C;
//C# TO JAVA CONVERTER TODO TASK: Java annotations will not correspond to .NET attributes:
    public byte[] s17C;
    /**
     * Order ticket
...
//ORIGINAL LINE: [FieldOffset(400)] public long OrderTicket;
    ...
    //C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: [FieldOffset(408)][MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 64)] public byte[] s198;
//C# TO JAVA CONVERTER TODO TASK: Java annotations will not correspond to .NET attributes:
    public byte[] s198;
    //C# TO JAVA CONVERTER TODO TASK: Java annotations will not correspond to .NET attributes:
...
//ORIGINAL LINE: [FieldOffset(508)] public PlacedType PlacedType;
    ...
    //C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: [FieldOffset(512)][MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 16)] public byte[] s200;
//C# TO JAVA CONVERTER TODO TASK: Java annotations will not correspond to .NET attributes:
    public byte[] s200;
    /**
     * Price
...
//C# TO JAVA CONVERTER TODO TASK: Java annotations will not correspond to .NET attributes:
    ...
    //C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: [FieldOffset(568)][MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 32)] public byte[] s238;
//C# TO JAVA CONVERTER TODO TASK: Java annotations will not correspond to .NET attributes:
    public byte[] s238;
    /**
     * Expert id
...
//ORIGINAL LINE: [FieldOffset(600)] public long ExpertId;
     ...
     */
//C# TO JAVA CONVERTER TODO TASK: Java annotations will not correspond to .NET attributes:
//ORIGINAL LINE: [FieldOffset(608)][MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 16)] public string Comment;
...
//ORIGINAL LINE: [FieldOffset(680)] public long ByCloseTicket;
    ...
    //C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: [FieldOffset(688)][MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 112)] public byte[] s2B0;
//C# TO JAVA CONVERTER TODO TASK: Java annotations will not correspond to .NET attributes:
    public byte[] s2B0;
}