...
public class BuildRec implements FromBufReader //sizeof 0x20 c
{
    /*[FieldOffset(0)]*/ public short s0;
    /*[FieldOffset(2)]*/ public Code StatusCode = Code.values()[0]; //2
    /*[FieldOffset(6)]*/ public short Build; //6
    /*[FieldOffset(8)]*/ /*[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 16)]*///C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
