...
public class TradeResult implements FromBufReader {
    /*[FieldOffset(0)]*/ public Code Status = Code.values()[0];
...
//ORIGINAL LINE: public byte[] s84;
    ...
    public Object ReadFromBuf(InBuf buf) {
        ...
        st.Status = Code.getById(BitConverter.ToInt32(buf.Bytes(4), 0));
