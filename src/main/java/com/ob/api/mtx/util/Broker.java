...
public class Broker {
    ...
    public String Search(String company, String serverType) throws IOException, NoSuchAlgorithmException, KeyManagementException {
        String result = cache.asMap().get(company);
        if (!Objects.isNull(result))
            return result;
        String ver = serverType;
